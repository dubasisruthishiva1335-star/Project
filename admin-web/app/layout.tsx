            ...
            <aside className="hidden w-56 shrink-0 flex-col justify-between border-r border-white/10 p-6 sm:flex">
              <div>
                ...
                <nav className="space-y-1 text-sm text-white/60">
                  ...
                  <Link href="/admin/internships" className={`block rounded-lg px-3 py-2 transition-colors ${pathname === "/admin/internships" ? "bg-white/10 text-accentCyan font-medium" : "hover:bg-white/5 hover:text-white"}`}>🎓 Internship Hub ⭐</Link>
