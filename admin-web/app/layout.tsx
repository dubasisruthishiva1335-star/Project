            ...
            <aside className="hidden w-56 shrink-0 flex-col justify-between border-r border-white/10 p-6 sm:flex">
              <div>
                ...
                <nav className="space-y-1 text-sm text-white/60">
                  ...
                  <Link href="/admin/courses" className={`block rounded-lg px-3 py-2 transition-colors ${pathname.includes("/courses") ? "bg-white/10 text-accentCyan font-medium" : "hover:bg-white/5 hover:text-white"}`}>🎓 Courses & Learning Hub</Link>
                  <Link href="/admin/competitive-exams" className={`block rounded-lg px-3 py-2 transition-colors ${pathname.includes("/competitive-exams") ? "bg-white/10 text-accentCyan font-medium" : "hover:bg-white/5 hover:text-white"}`}>🎯 Competitive Exams & Prep</Link>
                  ...
                  <Link href="/admin/internships" className={`block rounded-lg px-3 py-2 transition-colors ${pathname.includes("/internships") ? "bg-white/10 text-accentCyan font-medium" : "hover:bg-white/5 hover:text-white"}`}>💼 Career & Internships</Link>
                </nav>
              </div>
